...
int psoc6_smif_read(const struct flash_area *fa, off_t addr, void *data, size_t len);
int psoc6_smif_write(off_t addr, const void *data, size_t len);
int psoc6_smif_erase(off_t addr, size_t size);

int psoc6_smif_write_hal(uint8_t data[],
                            uint32_t address,
                            uint32_t len);
